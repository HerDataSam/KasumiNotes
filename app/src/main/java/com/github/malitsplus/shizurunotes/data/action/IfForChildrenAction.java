...
enum IfType {
    ...
    public String description() {
        switch (this) {
            ...
            case hastened:
                return I18N.getString(R.string.hastened);
            case blind:
            ...
            case polymorph:
                return I18N.getString(R.string.polymorphed);
            case hex:
                return I18N.getString(R.string.hexed);
            case curseOrHex:
                return I18N.getString(R.string.cursed_or_hexed);
            case fear:
                return I18N.getString(R.string.feared);
            case spy:
                return I18N.getString(R.string.is_invisible);
            case magicDefDecreased:
                return I18N.getString(R.string.magic_defence_decreased);
            default:
...
public class IfForChildrenAction extends ActionParameter {
    ...
    public String localizedDetail(int level, Property property) {
        if (actionDetail1 == 100 || actionDetail1 == 101 || actionDetail1 == 200 || actionDetail1 == 300 || actionDetail1 == 500 || actionDetail1 == 501
                ...
                || actionDetail1 == 1300 || actionDetail1 == 1400 || actionDetail1 == 1600
                || actionDetail1 == 1800 || actionDetail1 == 1900 || (actionDetail1 >= 6000 && actionDetail1 < 7000)) {
