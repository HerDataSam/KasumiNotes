...
class UnitCoefficient (
    ...
    var overall_coefficient: Double = 0.0,
    var skill1_evolution_coefficient: Int = 0,
    var skill1_evolution_slv_coefficient: Double = 0.0,
    var skill2_evolution_coefficient: Int = 0,
