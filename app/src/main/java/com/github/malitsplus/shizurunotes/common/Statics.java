...
public class Statics {
    ...
    /*  CN data base
        ...
        战数据的原因。这个问题和多目标Boss一样，进度赶上来后会自动解决。想要手动解决这个问题，需要重写会战相关
        SQL，可能还需要调整相关的实体类（我也没解析过早期版本的会战表，只能云一下）。
    */
...
//    public static final String LATEST_VERSION_URL = API_URL + "/last_version_cn.json";
    ...
    public static final String EQUIPMENT_ICON_URL = DB_URL + "/icon/equipment/%d.webp";
