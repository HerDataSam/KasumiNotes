        ...
        switch (barrierType){
            case physicalGuard:
                return I18N.getString(R.string.Cast_a_barrier_on_s1_to_strike_back_s2_damage_when_taking_physical_damage,
                        ...
                        buildExpression(level, actionValues, RoundingMode.CEILING, property, false, false, true, ClassModifier.physical, false),
            ...
            case magicalGuard:
                return I18N.getString(R.string.Cast_a_barrier_on_s1_to_strike_back_s2_damage_when_taking_magical_damage,
                        targetParameter.buildTargetClause(),
                        buildExpression(level, actionValues, RoundingMode.CEILING, property, false, false, true, ClassModifier.magical, false),
                        actionValue3.valueString());
            case physicalDrain:
                return I18N.getString(R.string.Cast_a_barrier_on_s1_to_strike_back_s2_damage_and_recover_the_same_HP_when_taking_physical_damage,
                        targetParameter.buildTargetClause(),
                        buildExpression(level, actionValues, RoundingMode.CEILING, property, true, false, true, ClassModifier.physical, false),
                        actionValue3.valueString());
            case magicalDrain:
                return I18N.getString(R.string.Cast_a_barrier_on_s1_to_strike_back_s2_damage_and_recover_the_same_HP_when_taking_magical_damage,
                        targetParameter.buildTargetClause(),
                        buildExpression(level, actionValues, RoundingMode.CEILING, property, true, false, true, ClassModifier.magical, false),
                        actionValue3.valueString());
            case bothGuard:
                return I18N.getString(R.string.Cast_a_barrier_on_s1_to_strike_back_s2_damage_when_taking_damage,
                        targetParameter.buildTargetClause(),
                        buildExpression(level, actionValues, RoundingMode.CEILING, property, false, false, true, ClassModifier.unknown, false),
                        actionValue3.valueString());
            case bothDrain:
                return I18N.getString(R.string.Cast_a_barrier_on_s1_to_strike_back_s2_damage_and_recover_the_same_HP_when_taking_damage,
                        targetParameter.buildTargetClause(),
                        buildExpression(level, actionValues, RoundingMode.CEILING, property, true, false, true, ClassModifier.unknown, false),
                        actionValue3.valueString());
            default:
