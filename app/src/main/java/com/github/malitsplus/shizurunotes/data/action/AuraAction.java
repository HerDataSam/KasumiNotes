        ...
        public String description() {
            switch (this) {
                ...
                case receivedCriticalDamage:
                    return I18N.getString(R.string.Received_Critical_Damage);
                case receivedDamage:
                    return I18N.getString(R.string.received_damage);
                case receivedPhysicalDamage:
                    return I18N.getString(R.string.received_physical_damage);
                case receivedMagicalDamage:
                    return I18N.getString(R.string.received_magical_damage);
                case maxHP:
                    return I18N.getString(R.string.max_HP);
                default:
                    return "";
            }
        }
