...
class TowerWaveFragment : Fragment(), OnWaveClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        towerWaveVM =
            ViewModelProvider(this, SharedViewModelTowerFactory(sharedTowerArea))[TowerWaveViewModel::class.java]
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sharedTowerArea.selectedTowerArea.observe(viewLifecycleOwner, Observer {
