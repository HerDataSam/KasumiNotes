...
public class SummonAction extends ActionParameter {
    ...
    enum Side {
        ...
        public String description() {
            switch (this) {
                case ours:
                    return I18N.getString(R.string.own_side);
                case other:
                    return I18N.getString(R.string.opposite);
                default:
    ...
    enum UnitType {
        ...
        public String description() {
            switch (this) {
                case normal:
                    return I18N.getString(R.string.normal_type);
                case phantom:
                    return I18N.getString(R.string.phantom_type);
                default:
                    return I18N.getString(R.string.unknown);
            }
        }
